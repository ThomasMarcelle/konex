  ...
  return (
    <div className="min-h-screen bg-[#020408] flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-[#0A0C10] border border-white/10 rounded-2xl p-8 shadow-2xl relative z-10">
        ...
        <h1 className="text-2xl font-medium text-white text-center mb-2">Bon retour</h1>
        <p className="text-slate-400 text-center text-sm mb-8">Connectez-vous à votre espace</p>

        <LoginForm />
        
        <div className="mt-6 text-center">
          <p className="text-slate-500 text-xs">
            Pas encore de compte ? <Link href="/register" className="text-blue-400 hover:text-blue-300 transition-colors">S'inscrire</Link>
          </p>
        </div>
      </div>
    </div>
